...
class MANGOS_DLL_SPEC WorldSession
{
    ...
    public:                                                 // opcodes handlers
        ...
        void HandleDismissControlledVehicleOpcode(WorldPacket& recvPacket);
        void HandleRequestVehicleExitOpcode(WorldPacket& recvPacket);
        void HandleRequestVehicleSwitchSeatOpcode(WorldPacket& recvPacket);
        void HandleChangeSeatsOnControlledVehicleOpcode(WorldPacket& recvPacket);
